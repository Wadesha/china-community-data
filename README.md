...
真实数据接入后,只需替换 `communities.json` 为相同结构的文件,各页面无需改版(三部百科卷不读数据文件,更不受影响)。
...
概念框架的全部法律、标准、政府文件来源列于 `index.html` §10(共 28 项),包括 GB 50180-2018、《物业管理条例》及各省实施办法、《不动产登记暂行条例实施细则》、《地名管理条例》、《城市房地产管理法》、《民法典》第 359 条、民政部行政区划统计等。三部百科卷的制度文本来源分别列于各自页内附录 B。
